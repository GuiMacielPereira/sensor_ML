...
_ = run_network(CNN, Xraw, yraw, n_ch=1, n_epochs=100, n_folds=10, n_runs=1, plots=True, n_batches=15, random_resampling=False)

#%%
from peratouch.networks import LSTM 
Xraw, yraw = load_data(path_five_users_main)
_ = run_network(LSTM, Xraw, yraw, input_size=16, hidden_size=16, n_ch=1, n_epochs=100, n_folds=10, n_runs=1, plots=True, n_batches=15, random_resampling=False)

#%%
from peratouch.networks import CNN_LSTM 
Xraw, yraw = load_data(path_five_users_main)
_ = run_network(CNN_LSTM, Xraw, yraw, n_ch=1, n_epochs=100, n_folds=10, n_runs=1, plots=True, n_batches=15, random_resampling=False)
